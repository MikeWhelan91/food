...
enum MockData {
    static func seed(in context: ModelContext) {
        let items = [
            ...
            InventoryItem(productName: "Semi Skimmed Milk", brand: "Avonmore", quantity: 1, unit: .bottle, category: .fridge, locationName: "Fridge door", purchaseDate: .daysFromNow(-1), estimatedDepletionDate: .daysFromNow(3), imageSystemName: "carton", expiry: ExpiryInfo(date: .daysFromNow(3), label: "Best Before", confidence: 0.86, source: "Barcode", rawText: "")),
            InventoryItem(productName: "Eggs", brand: "Farmhouse", quantity: 6, unit: .each, category: .fridge, locationName: "Top shelf", purchaseDate: .daysFromNow(-3), estimatedDepletionDate: .daysFromNow(4), imageSystemName: "oval.grid.3x3", expiry: ExpiryInfo(date: .daysFromNow(6), label: "Best Before", confidence: 0.75, source: "Manual", rawText: "")),
