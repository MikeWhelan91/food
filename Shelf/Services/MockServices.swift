...
struct MockProductLookupService: ProductLookupServicing {
    private static let cache: [String: ProductLookupResult] = [
        "5000112548167": ProductLookupResult(barcode: "5000112548167", name: "Coke Zero", brand: "Coca-Cola", category: .pantry, imageSystemName: "waterbottle", confidence: 0.96, source: "Open Food Facts mock"),
        "5010255079763": ProductLookupResult(barcode: "5010255079763", name: "Semi Skimmed Milk", brand: "Avonmore", category: .fridge, imageSystemName: "takeoutbag.and.cup.and.straw", confidence: 0.94, source: "Local cache"),
        "0000000000012": ProductLookupResult(barcode: "0000000000012", name: "Free Range Eggs", brand: "Farmhouse", category: .fridge, imageSystemName: "circle.grid.3x3", confidence: 0.9, source: "Remote mock")
    ]
...
struct MockSmartScanService: SmartScanServicing {
    func detectItems(images: [ScanImagePayload]) async throws -> [DetectedInventoryItem] {
        ...
        return [
            DetectedInventoryItem(name: "Milk", brand: "Avonmore", quantity: 1, category: .fridge, expiryDate: .daysFromNow(3), confidence: 0.92, imageSystemName: "takeoutbag.and.cup.and.straw"),
            DetectedInventoryItem(name: "Eggs", brand: "Farmhouse", quantity: 6, category: .fridge, expiryDate: .daysFromNow(6), confidence: 0.88, imageSystemName: "circle.grid.3x3"),
            ...
            DetectedInventoryItem(name: "Coke Zero", brand: "Coca-Cola", quantity: 4, category: .pantry, expiryDate: .daysFromNow(60), confidence: 0.86, imageSystemName: "waterbottle"),
